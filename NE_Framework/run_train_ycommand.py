"""
run_train_ycommand.py — Trained NE, binary command output [forward, yaw_increase, yaw_decrease].

Each individual is trained on pilot data via backprop before fitness is evaluated.
Output model: train_ycommand/best_model/best_model_train_ycommand.pth
"""
...
X_eval, y_cmd_eval, _, _ = load_json(TESTING_FILE)
X_eval   = X_eval.to(DEVICE)
y_eval   = y_cmd_eval.to(DEVICE)
