"""
run_notrain_ymotors.py — Untrained NE, motor velocity output [m1, m2, m3, m4].
...
Output model: notrain_ymotors/best_model/best_model_notrain_ymotors.pth
"""
...
BASE_DIRECTORY = 'notrain_ymotors'
